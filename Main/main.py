...
class Application:
    ...
    def main(self):
        ...
        buttonStock = tk.Button(frameButtons, text = "Display Stock", command = lambda : self.ShowStock(frameDisplay), state = "disabled", relief = "raised")
        buttonStock.grid(column = 0, row = 0, sticky = "wesn")
        buttonHistory = tk.Button(frameButtons, text = "Display History", command = lambda : self.ShowHistory(frameDisplay), relief = "raised")
